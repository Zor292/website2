...
const RP_ROLES = {
  '1477281664907481108': { name: 'حاكم',                color: '#ffd700' },
  '1477439588174921940': { name: 'نائب الحاكم',         color: '#ffaa00' },
  '1477436392790298798': { name: 'قائد الشرطة',         color: '#4a90d9' },
  '1477434865971363943': { name: 'نائب قائد الشرطة',    color: '#5599cc' },
  '1471908537331617976': { name: 'أفراد الشرطة',        color: '#2266cc' },
  '1471915477063176467': { name: 'وزير الدفاع المدني',  color: '#33aa55' },
  '1471916760826511524': { name: 'وزير الصحة',          color: '#ff5555' },
  '1471965836792299562': { name: 'زعيم العصابات',       color: '#cc4400' },
  '1472606415892774972': { name: 'مجرم',                color: '#aa0000' },
};

const POLICE_ROLE_IDS = ['1477436392790298798','1477434865971363943','1471908537331617976'];
